...
namespace ThinkRing
{
    //class from RustyMachine.dll (Rain World 1.5 mod)
    public class LightningBolt : UpdatableAndDeletable, IDrawable
    {
        ...
        public Color color, colorFade; //added color arguments


        public LightningBolt(Vector2 startPoint, Vector2 endPoint, float lifetime, Color color, Color colorFade)
        {
            this.startPoint = startPoint;
            this.endPoint = endPoint;
            this.maxLifetime = lifetime;
            this.lifetime = lifetime;
            this.stuckAt = startPoint + Random.insideUnitCircle * 5f;
            this.handle = this.stuckAt + Custom.RNV() * Mathf.Lerp(30f, 100f, Random.value);
            this.color = color;
        ...
        public void DrawSprites(RoomCamera.SpriteLeaser sLeaser, RoomCamera rCam, float timeStacker, Vector2 camPos)
        {
            ...
            triangleMesh.color = Color.Lerp(color, colorFade, 1f - this.lifetime / this.maxLifetime);
        }
